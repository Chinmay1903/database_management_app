                        ...
                        {columns.map((col, i) => (
                            <Form.Group key={i} className="mb-3">
                                ...
                                <Form.Control
                                    type="text"
                                    name={col}
                                    disabled={col === 'id' || col.toLowerCase() === 'created_at'}
                                    placeholder={col.toLowerCase() === 'id' || col.toLowerCase() === 'created_at'? `${col} will be auto-generated` : `Enter ${col}`}
                                    value={formData[col] || ''}
                                    onChange={handleChange}
                                    required={col !== 'id' && col !== 'created_at'}
                                />
                            </Form.Group>
                        ))}
